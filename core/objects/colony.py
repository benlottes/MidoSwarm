...
class Colony(SimObject):
    ...
    def __init__(self, num_agents: int) -> None:
        ...
        self.agents = [
            Agent(
                (randint(0, settings.MAP_SIZE[0] - 1), randint(0, settings.MAP_SIZE[1] - 1)),
                settings.AGENT_STARTING_NUTRITION,
                settings.AGENT_STARTING_HEALTH,
                settings.AGENT_MAX_HEALTH
